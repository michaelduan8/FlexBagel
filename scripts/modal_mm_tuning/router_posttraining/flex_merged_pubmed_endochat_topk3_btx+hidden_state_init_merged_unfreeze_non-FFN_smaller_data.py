...
COMMAND = f"""
    ...
    --run_id "flex_merged_pub_endo_qwen2_5-3b-vl-flex-topk2-hidden_state_init-router_posttuning_topk3-unfreeze_non_ffn_smaller_tune_dataset_25k" \
    --model micdun/flex_merged_pubmed_endochat_btx_qwen2_5-3x3b-vl-flex-router_hidden_state_init_untrained \
    --datasets /mnt/finevision/finevision_train_100k_w_length_w_path.jsonl /mnt/pubmedvision/pubmed_vision_it_train_w_length_w_path.jsonl /mnt/surg390k/surg_390k_train_w_length_w_path.jsonl \
    --sample_size 25000 25000 25000 \
    --router_tuning_only \
    --unfreeze_non_ffn \
    --num_train_epochs 1 \
...
@app.function(image=image, 
    volumes={"/hf-cache": vol_hf_cache, "/mnt/pubmedvision": vol_pubmed_data, "/mnt/surg390k": vol_endochat_data, "/mnt/finevision": vol_finevision_data, "/output": vol_output}, 
