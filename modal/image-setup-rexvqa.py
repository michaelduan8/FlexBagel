...
COMMAND = """
cd /FlexBagel && PYTHONPATH=.  torchrun --master_port=29501 --nproc_per_node=2  train/mm_tune.py \
    --run_id "rexvqa_qwen2_5-3b-vl-2-gpus" \
    --model Qwen/Qwen2.5-VL-3B-Instruct \
    --datasets /mnt/rexvqa/rexvqa_train_w_length_w_path.jsonl \
    --sample_size 500000 \
    --num_train_epochs 1 \
...
# COMMAND = """
# cd /FlexBagel && PYTHONPATH=. python train/mm_tune.py \
#     --run_id "rexvqa_qwen2_5-3b-vl-1-gpu" \
#     --model Qwen/Qwen2.5-VL-3B-Instruct \
#     --datasets /mnt/rexvqa/rexvqa_train_w_length_w_path.jsonl \
#     --sample_size 500000 \
#     --num_train_epochs 1 \
...
#     --run_id "rexvqa_qwen2_5-3b-vl-corrected" \
#     --model Qwen/Qwen2.5-VL-3B-Instruct \
#     --datasets /mnt/rexvqa/train_vqa_data_filtered.jsonl \
#     --sample_size 500000 \
#     --num_train_epochs 1 \
#     --per_device_train_batch_size 4 \
#     --per_device_eval_batch_size 2 \
...
# COMMAND = """
# cd /FlexBagel && PYTHONPATH=. python train/mm_tune.py \
#     --run_id "rexvqa_qwen2_5-3b-vl-test" \
#     --model Qwen/Qwen2.5-VL-3B-Instruct \
#     --datasets /mnt/rexvqa/train_vqa_data_filtered.jsonl \
#     --sample_size 50000 \
#     --num_train_epochs 1 \
...
vol_data = modal.Volume.from_name("rexvqa", create_if_missing=False)
...
@app.function(image=image, 
    volumes={"/hf-cache": vol_hf_cache, "/mnt/rexvqa": vol_data, "/output": vol_output}, 
