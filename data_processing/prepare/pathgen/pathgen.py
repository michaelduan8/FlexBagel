...
def main() -> None:
    ...
    unique_wsi_count = len(dataset.unique("wsi_id"))
    # dataset = load_dataset("json", data_files=str(dataset_path), split="train")
    dataset = dataset.filter(
        lambda row, raw_data_dir: os.path.exists(os.path.join(raw_data_dir, row["image"].replace(".jpg", ".png"))),
    ...
    print(f"Unique wsi_id values: {unique_wsi_count}")
